...
class ReviewFormElementGridRow extends GridRow {
		...
		if (!empty($rowId) && is_numeric($rowId)) {
			...
			$this->addAction(
				new LinkAction(
					'edit',
					new AjaxModal(
						$router->url($request, null, null, 'editReviewFormElement', null, array('rowId' => $rowId)),
						__('grid.action.edit'),
						'modal_edit',
						true
					),
			...
			$this->addAction(
				new LinkAction(
					...
					new RemoteActionConfirmationModal(
						...
						null,
						$router->url($request, null, null, 'deleteReviewFormElement', null, array('rowId' => $rowId))
					),
		...
		return 'manager.reviewFormElements.confirmDelete';
        }
}
?>
