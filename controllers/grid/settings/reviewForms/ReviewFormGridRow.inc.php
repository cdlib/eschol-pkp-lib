...
class ReviewFormGridRow extends GridRow {
	/**
			...
			// add 'preview' grid row action
                        $this->addAction(
                                new LinkAction(
                                        'preview',
                                        new AjaxModal(
                                                $router->url($request, null, null, 'previewReviewForm', null, array('rowId' => $rowId)), #url
        ...
        /**
         * Get the delete reviewForm row locale key.
         * @return string
         */
        function getConfirmDeleteKey() {
		return 'manager.reviewForms.confirmDeleteUnpublished';
        }

	/**
         * Get the copy reviewForm row locale key.
         * @return string
         */
        function getConfirmCopyKey() {
                return 'manager.reviewForms.confirmCopy';
        }
}
