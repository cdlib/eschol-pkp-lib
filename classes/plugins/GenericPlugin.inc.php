	...
	function manage($verb, $args, &$message) {
		...
		switch ($verb) {
			case 'enable':
				...
				$message = \OjsLocale::translate('common.pluginEnabled', array('pluginName' => $this->getDisplayName()));
				return false;

			case 'disable':
				$this->setEnabled(false);
				$message = \OjsLocale::translate('common.pluginDisabled', array('pluginName' => $this->getDisplayName()));
				return false;
		}
